...
public class FileFindListEntity {
	private int count;
...
//		}
	...
	public void setType(int type) {
	 ...
	 public FileFindListEntity(int count, String order, int uid, boolean state,
	...
	public FilesListEntity getFilesListEntity(){
		...
		FilesListEntity entity = new FilesListEntity(count, order, uid, state, error, errno, time, offset, limit, aid, cid, is_asc, star, is_share, type, fatherEntities, null);
